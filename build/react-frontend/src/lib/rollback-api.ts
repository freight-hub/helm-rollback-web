...
export class MockRollbackApi implements RollbackApi {
  ...
  async getReleaseList() {
    return parseDates([
      ...
      { "name": "fortox-backend", "namespace": "pomato", "revision": "1074", "updated": "2021-03-05T08:24:06.466948093Z", "status": "deployed", "chart": "fortox-backend-0.1.0", "app_version": "680972d0ba47bcbcf7fa062743fbc0aea400e3fc" },

...
function LoginOrWho() {
  ...
  if (dd == null || !dd.hasOwnProperty("email") || dd.email == null) {
    return( <Button class="MuiButtonBase-root MuiButton-root MuiButton-contained MuiButton-containedPrimary LoginButton" variant="contained" color="primary" href="/login">
      Log in with Google
    </Button>)
  } else {
    return (
